...
public class UserModel{
	...
	public UserModel(String firstName, String lastName, String phoneNumber, String email, String password,
			String citizenshipNo, String licenseNo, String profileImage) {
		super();
